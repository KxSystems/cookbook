...
Create c:\rserver and copy the files there, also copy in R.dll from the R bin directory, i.e. c:\Program Files\R\R-2.11.1\bin\R.dll. Create c:\c and copy common.c and rserver.c there. 
